...
// assertTrue(result.getDescription().contains("Missing required method calls
// inside loops: doesntExist"));
// }
...
// assertTrue(result.getDescription().contains("Calls inside conditionals:
// simulate"));
// assertTrue(result.getDescription().contains("Missing required method calls
// inside conditionals: momma"));
// }
// }
