...
public class JavaParserTest {
    ...
    public void shouldHaveClass() {
        ...
        List<ClassOrInterfaceDeclaration> classes = ast.getRoot().findAll(ClassOrInterfaceDeclaration.class);

        for (ClassOrInterfaceDeclaration singleClass : classes) {
            if (!singleClass.isInterface() && singleClass.getNameAsString().equals("Test")) {
                foundClass = true;
            }
        }
    ...
    public void shouldHaveClasssTwo() {
        ...
        Optional<ClassOrInterfaceDeclaration> studentClass = ast.getRoot().getClassByName("Test");
